...
class DataBase:
    ...
    def register(self, symbol, value, dollar, leverage):
        with self.connection as con:
            con.execute("INSERT INTO symbols (symbol, price, dollar, leverage) ""VALUES (?, ?, ?, ?)",
                        (symbol, value, dollar, leverage))

    def new_value(self, symbol, value, dollar, leverage):
        with self.connection:
            ...
            self.cursor.execute("UPDATE symbols SET leverage=? WHERE symbol=?", (0, leverage,))
    ...
    def get_symbols(self):
        ...
        with self.connection:
            ...
            for i in row_list:
                final_dict[list(i)[1]] = [list(i)[2], list(i)[3], list(i)[4], list(i)[5]]
            return final_dict
